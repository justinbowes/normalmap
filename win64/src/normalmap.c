...
static void make_heightmap(unsigned char *image, int w, int h, int bpp, struct NormalmapVals nmapvals)
{
...
int32_t normalmap(uint8_t * img, uint8_t * nm_img, size_t width, size_t height, struct NormalmapVals nmapvals)
{
    const size_t bpp = 4;
    size_t rowbytes;
    int x, y;
